...
树莓派OS 自带 Java for ARM 安装。如果你运行`java –version`，它会打印出来
...
树莓派4 型号 B GPIO 引脚排列。图片来自 [`https://pi4j.com/assets/documentation/headerpins_in_header.png`](https://pi4j.com/assets/documentation/headerpins_in_header.png)
