...
![Tab06-01.jpg](images/Tab06-01.jpg)
...
6.10.1 估算![root-5.jpg](images/root-5.jpg)

我们使用随机数根据以下公式估算 5 的平方根:

*   它在两点和三点之间。
*   *x* 小于![root-5.jpg](images/root-5.jpg)如果*x*T5】2 小于 5。
*   生成 2 到 3 之间的带分数的随机数。对那些小于![root-5.jpg](images/root-5.jpg)的数字进行计数。
*   设`maxCount`为 2 到 3 之间产生的随机数总数。用户将提供`maxCount`。
*   设`amountLess`是小于的那些数的计数。
*   ![pg184.jpg](images/pg184.jpg)给出了![root-5.jpg](images/root-5.jpg)的近似值

为了理解该方法背后的思想，考虑 2 和 3 之间的线段，让点`r`表示 5 的平方根。

![9781430266198_unFig06-01.jpg](images/9781430266198_unFig06-01.jpg)
...
[程序 P6.7](#list7) 基于此方法计算出![root-5.jpg](images/root-5.jpg)的估算值。记住`Math.random`生成一个随机分数。

当运行 1000 个数字时，这个程序给出 2.234 作为 5 的平方根。![root-5.jpg](images/root-5.jpg)的值是 2.236 到小数点后三位。
...
![9781430266198_Fig06-01.jpg](images/9781430266198_Fig06-01.jpg)

[图 6-1](#_Fig1) 。在正方形内画圈

如果你闭上眼睛，继续用铅笔反复戳图，你可能会得到类似于[图 6-2](#Fig2) 的东西(只考虑落在图中的点)。

![9781430266198_Fig06-02.jpg](images/9781430266198_Fig06-02.jpg)
...
![pg185.jpg](images/pg185.jpg)

请注意，正方形内的点数也包括圆形内的点数。如果我们想象整个正方形充满了点，那么前面的近似将是相当准确的。我们现在展示如何使用这个想法来估计π。

考虑[图 6-3](#Fig3) 。

![9781430266198_Fig06-03.jpg](images/9781430266198_Fig06-03.jpg)

[图 6-3](#_Fig3) 。四分之一圆和一个正方形

*   c 是半径为 1 的四分之一圆；s 是边长为 1 的正方形。
*   面积 C = ![fracpiby4.jpg](images/fracpiby4.jpg)面积 S = 1。
...
![pg186.jpg](images/pg186.jpg)

C 的面积为![fracpiby4.jpg](images/fracpiby4.jpg)，S 的面积为 1。因此，以下成立:

![pg186a.jpg](images/pg186a.jpg)

因此:

![pg186b.jpg](images/pg186b.jpg)
