...
![A978-1-4302-6662-4_8_Fig1_HTML.jpg](A978-1-4302-6662-4_8_Fig1_HTML.jpg)
...
如果你想打印本机代码中异常的堆栈跟踪，你可以使用`ExceptionDescribe()` JNI 函数。它在标准错误上打印异常堆栈跟踪。如果想从本机代码中引发致命错误，可以使用`FatalError(const char *msg)` JNI 函数。函数不会返回，JVM 也不会从这个错误中恢复。Java 代码中声明的本机方法也可以像 Java 非本机方法一样使用`throws`子句。以下是 Java 类中有效的本机方法声明:
