...
![img/336502_2_En_12_Fig5_HTML.jpg](img/336502_2_En_12_Fig5_HTML.jpg)
...
![img/336502_2_En_12_Fig13_HTML.jpg](img/336502_2_En_12_Fig13_HTML.jpg)
...
![img/336502_2_En_12_Fig16_HTML.jpg](img/336502_2_En_12_Fig16_HTML.jpg)
...
![img/336502_2_En_12_Fig18_HTML.png](img/336502_2_En_12_Fig18_HTML.png)
...
![img/336502_2_En_12_Fig28_HTML.jpg](img/336502_2_En_12_Fig28_HTML.jpg)
...
![img/336502_2_En_12_Fig30_HTML.png](img/336502_2_En_12_Fig30_HTML.png)

图 12-30

`ColorPicker`控件及其调色板对话框

![img/336502_2_En_12_Fig29_HTML.png](img/336502_2_En_12_Fig29_HTML.png)
...
![img/336502_2_En_12_Fig31_HTML.jpg](img/336502_2_En_12_Fig31_HTML.jpg)
...
`ColorPicker`类有两个构造器。其中一个是默认构造器，另一个以初始颜色作为参数。默认构造器使用白色作为初始颜色，如下面的代码所示:
...
![img/336502_2_En_12_Fig32_HTML.jpg](img/336502_2_En_12_Fig32_HTML.jpg)
...
![img/336502_2_En_12_Fig33_HTML.jpg](img/336502_2_En_12_Fig33_HTML.jpg)
...
您可以使用默认构造器创建一个`DatePicker`；它使用`null`作为初始值。您也可以将一个`LocalDate`作为初始值传递给另一个构造器，如下面的代码所示:
...
清单 [12-24](#PC99) 包含了一个`LocalDateStringConverter`类的代码，它是`LocalDate`的`StringConverter`。默认情况下，它将日期格式化为`MM/dd/yyyy`格式。您可以在其构造器中传递不同的格式。
...
![img/336502_2_En_12_Fig34_HTML.jpg](img/336502_2_En_12_Fig34_HTML.jpg)
...
![img/336502_2_En_12_Fig35_HTML.jpg](img/336502_2_En_12_Fig35_HTML.jpg)
...
![img/336502_2_En_12_Fig36_HTML.png](img/336502_2_En_12_Fig36_HTML.png)
...
![img/336502_2_En_12_Fig37_HTML.jpg](img/336502_2_En_12_Fig37_HTML.jpg)
...
![img/336502_2_En_12_Fig38_HTML.jpg](img/336502_2_En_12_Fig38_HTML.jpg)
...
![img/336502_2_En_12_Fig39_HTML.jpg](img/336502_2_En_12_Fig39_HTML.jpg)
...
![img/336502_2_En_12_Fig40_HTML.jpg](img/336502_2_En_12_Fig40_HTML.jpg)

图 12-40

使用`PasswordField`控件的窗口

`PasswordField`类只提供了一个构造器，它是一个无参数的构造器。您可以使用`setText()`和`getText()`方法分别设置和获取`PasswordField`中的实际文本，如下面的代码所示。通常，您不需要设置密码文本。用户输入它。
...
![img/336502_2_En_12_Fig41_HTML.png](img/336502_2_En_12_Fig41_HTML.png)
...
![img/336502_2_En_12_Fig43_HTML.jpg](img/336502_2_En_12_Fig43_HTML.jpg)

图 12-43

不确定和确定状态下的`ProgressBar`控制

![img/336502_2_En_12_Fig42_HTML.jpg](img/336502_2_En_12_Fig42_HTML.jpg)
...
![img/336502_2_En_12_Fig44_HTML.jpg](img/336502_2_En_12_Fig44_HTML.jpg)
...
![img/336502_2_En_12_Fig45_HTML.png](img/336502_2_En_12_Fig45_HTML.png)

图 12-45

处于折叠和展开状态

使用默认构造器创建一个没有标题和内容的`TitledPane`。您可以稍后使用`setText()`和`setContent()`方法来设置它们。或者，您可以使用以下代码将标题和内容作为参数提供给其构造器:
...
![img/336502_2_En_12_Fig46_HTML.jpg](img/336502_2_En_12_Fig46_HTML.jpg)
...
![img/336502_2_En_12_Fig47_HTML.png](img/336502_2_En_12_Fig47_HTML.png)

图 12-47

一个`Accordion`带三个`TitledPanes`

`Accordion`类只包含一个构造器(无参数构造器)来创建它的对象:
...
![img/336502_2_En_12_Fig48_HTML.png](img/336502_2_En_12_Fig48_HTML.png)
...
![img/336502_2_En_12_Fig49_HTML.png](img/336502_2_En_12_Fig49_HTML.png)
...
`Pagination`类提供了几个构造器。它们以不同的方式配置控件。默认构造器创建一个控件，该控件具有不确定的页数，并以零作为选定页的索引，如下面的代码所示:
...
`currentPageIndex`是一个整数属性。它的值是要显示的页面的页面索引。默认值为零。您可以使用其中一个构造器或使用`setCurrentPageIndex()`方法来指定它的值。如果将其值设置为小于零，则第一页索引(为零)将被设置为其值。如果将其值设置为大于页数减 1，则其值将设置为页数减 1。如果您想知道新页面何时显示，可以在`currentPageIndex`属性中添加一个`ChangeListener`。
...
`pageCount`是一个整数属性。它是`Pagination`控件中的页数。其值必须大于或等于 1。它默认为不确定。它的值可以在构造器中设置或者使用`setPageCount()`方法。
...
![img/336502_2_En_12_Fig50_HTML.png](img/336502_2_En_12_Fig50_HTML.png)
...
![img/336502_2_En_12_Fig51_HTML.jpg](img/336502_2_En_12_Fig51_HTML.jpg)

图 12-51

显示工具提示的窗口

工具提示由继承自`PopupControl`类的`Tooltip`类的实例表示。工具提示可以包含文本和图形。您可以使用默认的构造器创建工具提示，该构造器没有文本和图形。您还可以使用其他构造器创建带有文本的工具提示，如下面的代码所示:
...
![img/336502_2_En_12_Fig52_HTML.jpg](img/336502_2_En_12_Fig52_HTML.jpg)
...
![img/336502_2_En_12_Fig53_HTML.png](img/336502_2_En_12_Fig53_HTML.png)
...
`ScrollBar`类提供了创建水平滚动条的默认构造器。您可以使用`setOrientation()`方法将其方向设置为垂直:
...
![img/336502_2_En_12_Fig54_HTML.jpg](img/336502_2_En_12_Fig54_HTML.jpg)
...
您可以使用`ScrollPane`类的构造器创建一个空的`ScrollPane`或一个带有内容节点的`ScrollPane`，如下面的代码所示。您可以稍后使用`setContent()`方法设置内容节点。
...
![img/336502_2_En_12_Fig55_HTML.jpg](img/336502_2_En_12_Fig55_HTML.jpg)
...
![img/336502_2_En_12_Fig56_HTML.jpg](img/336502_2_En_12_Fig56_HTML.jpg)

图 12-56

使用水平和垂直分隔符

默认的构造器创建一个水平的`Separator`。要创建一个垂直的`Separator`，可以在构造器中指定一个垂直方向或者使用`setOrientation()`方法，如下面的代码所示:
...
![img/336502_2_En_12_Fig57_HTML.png](img/336502_2_En_12_Fig57_HTML.png)

图 12-57

一扇横窗`SplitPane`

您可以使用`SplitPane`类的默认构造器创建一个`SplitPane`:
...
![img/336502_2_En_12_Fig58_HTML.png](img/336502_2_En_12_Fig58_HTML.png)
...
下面的代码使用默认构造器创建一个`Slider`控件，该构造器将 0、100 和 0 分别设置为最小值、最大值和当前值。默认方向是水平的。
...
![img/336502_2_En_12_Fig59_HTML.jpg](img/336502_2_En_12_Fig59_HTML.jpg)
...
![img/336502_2_En_12_Fig60_HTML.jpg](img/336502_2_En_12_Fig60_HTML.jpg)
...
![img/336502_2_En_12_Fig61_HTML.jpg](img/336502_2_En_12_Fig61_HTML.jpg)
...
![img/336502_2_En_12_Fig62_HTML.png](img/336502_2_En_12_Fig62_HTML.png)
...
菜单栏是作为菜单容器的水平栏。`MenuBar`类的一个实例代表一个菜单栏。您可以使用默认的构造器创建一个`MenuBar`:
...
`Menu`类的一个实例代表一个菜单。菜单显示文本和图形。使用默认构造器创建一个空菜单，然后设置文本和图形:
...
![img/336502_2_En_12_Fig63_HTML.jpg](img/336502_2_En_12_Fig63_HTML.jpg)
...
![img/336502_2_En_12_Fig64_HTML.jpg](img/336502_2_En_12_Fig64_HTML.jpg)
...
![img/336502_2_En_12_Fig65_HTML.jpg](img/336502_2_En_12_Fig65_HTML.jpg)
...
![img/336502_2_En_12_Fig66_HTML.jpg](img/336502_2_En_12_Fig66_HTML.jpg)
...
![img/336502_2_En_12_Fig67_HTML.jpg](img/336502_2_En_12_Fig67_HTML.jpg)
...
`CustomMenuItem`类提供了几个构造器。默认构造器创建一个自定义菜单项，将`content`属性设置为`null`并将`hideOnClick`属性设置为 true，如以下代码所示:
...
![img/336502_2_En_12_Fig68_HTML.jpg](img/336502_2_En_12_Fig68_HTML.jpg)
...
关于`SeparatorMenuItem`没有什么特别要讨论的。它继承自`CustomMenuItem`。它使用一个水平的`Separator`控件作为它的`content`，并将`hideOnClick`设置为假。它用于分隔属于不同组的菜单项，如下面的代码所示。它提供了一个默认的构造器:
...
`ContextMenu`类的默认构造器创建一个空菜单。您需要稍后添加菜单项:
...
![img/336502_2_En_12_Fig69_HTML.png](img/336502_2_En_12_Fig69_HTML.png)
...
![img/336502_2_En_12_Fig70_HTML.png](img/336502_2_En_12_Fig70_HTML.png)
...
![img/336502_2_En_12_Fig71_HTML.jpg](img/336502_2_En_12_Fig71_HTML.jpg)
...
![img/336502_2_En_12_Fig72_HTML.png](img/336502_2_En_12_Fig72_HTML.png)
...
您可以使用带有空标题的`Tab`类的默认构造器创建一个选项卡:
...
`text`、`graphic`和`closable`属性指定了标签标题栏中显示的内容。`text`属性指定一个字符串作为标题文本。`graphic`属性指定一个节点作为`title`图标。注意，graphic 属性的类型是`Node`，因此您可以使用任何节点作为图形。通常，小图标被设置为图形。可以在构造器中设置`text`属性，或者使用`setText()`方法。下面的代码片段创建了一个带有文本的选项卡，并将一个图像设置为其图形(假设文件`resources/picture/address_icon.png`包含在包中):
...
`TabPane`类只提供了一个构造器——默认构造器。当您创建`TabPane`时，它没有选项卡:
...
![img/336502_2_En_12_Fig73_HTML.jpg](img/336502_2_En_12_Fig73_HTML.jpg)
...
![img/336502_2_En_12_Fig74_HTML.jpg](img/336502_2_En_12_Fig74_HTML.jpg)
...
![img/336502_2_En_12_Fig75_HTML.jpg](img/336502_2_En_12_Fig75_HTML.jpg)
...
一个`HTMLEditor`类的实例代表一个`HTMLEditor`控件。该类包含在`javafx.scene.web`包中。使用默认的构造器，这是提供的唯一构造器，来创建一个`HTMLEditor`:
...
`FileChooser`类的一个实例用于打开文件对话框。该类包含一个无参数构造器来创建其对象:
